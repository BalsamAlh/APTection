...
#SigmaPath = f"{CurrentPath}/APT_SigmaRules"
...
def downloadRepo():
   #github_repository_url = 'https://github.com/Malakalmsad/APT_SigmaRules.git'
   github_repository_url = 'https://github.com/SigmaHQ/sigma.git'
   os.system(f'git clone {github_repository_url}')
   #os.system(f'cp -r {SigmaPath}/windows {CurrentPath}')
