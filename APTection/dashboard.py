        ...
        ui.row(
            ...
            ui.column(3, 
                    ui.div(
                        ...
                        # circle div
                        ui.div(
                            ui.span(ui.output_text("percentage2_"), class_=""),
                            div(
                                div(class_="first50-bar"),
            ...
            div(
                ...
                div(
                    ...
                    div(
                        ...
                        div(
                            div(
                                span("The current stage of the first highest APT attack: ",class_="h5"),
                                span(ui.output_text("current_attack_stage", inline=True),style="color:#BF0037;",class_="h5"),
                                class_="pt-5 px-2"
                            ),
                            div( 
                                span("The next stage of the first highest APT attack: ",class_="h5 pt-5"),
...
def server(input, output, session):
    ...
    output_filename = "./crossM.csv"
    stage_filename = "./Stages.xlsx"
    database_filename = "./APT TTP Represotory.xlsx"
