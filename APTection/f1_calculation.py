...
def calculate_score(database_filename, sheet_name):
    ...
    sheet_name:  Sheet name will the name of the sheet that will be generated by Cross_Matching.py file
    """
    ...
    # getting total techinques present in ID column of crossM.csv
    ti = list(mapping_dictionary.keys())

    # key contain technique name from ID column from crossM.csv
    # sheets_list carries the list of APTs that contain matching technique
